...
# Define Global Variables for Energy Tracking
total_kwh = 0.0
total_cost = 0.0
total_co2_kg = 0.0
peak_power_w = 0.0
...
def main():
    # Force Python to use the global variables instead of creating local ones
    global total_kwh, total_cost, total_co2_kg, peak_power_w 
    ...
    while True:
        ...
        # --- NEW LOGIC: Only read sensors if Relay is ON ---
        if relay.value() == 1:
            ...
            # If relay is off, zero everything out
            raw_current = 0
            raw_voltage = 0
            voltage_val = 0.0
            current_amp = 0.0
